...
<body style="background-color: #666666;">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form  id="frm-login" action="index.php?c=Login&a=enviar" method="post" enctype="multipart/form-data" class="login100-form validate-form">
         ...
         <label><p>Ingrese su correo electronico para que se envie su contraseña a su correo</p></label>
                <label><hr>
                    <span><h4><center>Correo Electronico.</center></h4></span>
                    <input type="text" class="form-control" name="correo_electronico" required="required" />
                </label>
                <hr>
