create database ventaycompra;
  use database ventaycompra;
...
CREATE TABLE `compra` (
  ...
  KEY `compra_ibfk_1` (`numero_id_empleado`),
  CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`numero_id_empleado`) REFERENCES `empleado` (`numero_id_empleado`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1
...
CREATE TABLE `detalle_registro_compra` (
  ...
  KEY `detalle_registro_compra_ibfk_1` (`codigo_compra`),
  KEY `detalle_registro_compra_ibfk_2` (`codigo_producto`),
  CONSTRAINT `detalle_registro_compra_ibfk_1` FOREIGN KEY (`codigo_compra`) REFERENCES `compra` (`codigo_compra`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `detalle_registro_compra_ibfk_2` FOREIGN KEY (`codigo_producto`) REFERENCES `producto` (`codigo_producto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1
